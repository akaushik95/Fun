 ...
 */
//public class SongListAdapterAlbums extends ArrayAdapter<Songs> {
//    ArrayList<Songs> mData;
//    Context context;
//
//public SongListAdapterAlbums(Context context,ArrayList<Songs> Obj){
//    super(context,0,Obj);
...
////        }
//    albumName.setText(obj.getSongAlbum());
////        songArtist.setText(obj.getSongArtist());
//    return v;
//    }
//}

public class SongListAdapterAlbums extends RecyclerView.Adapter<SongListAdapterAlbums.ourHolder> {
    Context mcontext;
    ArrayList<Songs> mData;
    ...
    public SongListAdapterAlbums(Context context, ArrayList<Songs> songs, songsListListener songsListListener) {
        super();
    ...
    @Override
    public SongListAdapterAlbums.ourHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mcontext).inflate(R.layout.songlayoutinlistview, parent, false);
        return new ourHolder(v);
    }

    @Override
    public void onBindViewHolder(SongListAdapterAlbums.ourHolder holder, int position) {
        final Songs songs = mData.get(position);
        holder.tv1.setText(songs.getSongAlbum());
